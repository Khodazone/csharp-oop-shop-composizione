...
namespace csharp_oop_shop_composizione
{
    public class Product
    {
        ...
        //CONSTRUCTOR
        public Product(string name, string description, float price, int iva = 22)
        {
            this.name = name;
        ...
        public string FormattedNum()// questo metodo formatta il numero dato e ci aggiunge 0 alla sinistra fino a raggiungere un massimo di 8 cifre
        {
            int padding = 0;
        ...
        public string CodeName() // ritorna una stringa con il codice formattato concatenato al nome.
        {
